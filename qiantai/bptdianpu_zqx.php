...
#twoo{
	...
	width:20%;
	margin-left:20%;
	background:url(../photo/baiputao.jpg);
	float:left;
}
#twooo{
	height:400px;
...
<div id="two">
  ...
  <div id="twooo">
    <h2>冰灵雷司令白葡萄酒</h2>
    <p>优质的雷司令葡萄酒10年左右成熟期。德国莱茵产区、莫塞尔产区的雷司令葡萄酒、部分阿尔萨斯的雷司令，适当的陈年可以丰富酒的香气，余味愈加悠长，有人将它们形容为成熟的贵妇人，需要时间慢慢欣赏。</p>
    <div id="twooo1">￥ 199.00</div><br/>
